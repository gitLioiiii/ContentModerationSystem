...
public class SensitiveWordServiceImpl implements SensitiveWordService {
    ...
    // 分页查询
    @Cacheable(value = "sensitiveWords", key = "#filter.toString()")
    @Override
    ...
    // 统计总数
    @Cacheable(value = "sensitiveWordsCount", key = "#filter.toString()")
    @Override
    ...
    // 创建敏感词
    @CacheEvict(value = {"sensitiveWords", "sensitiveWordsCount"}, allEntries = true)
    @Override
