...
public class ManualReviewServiceImpl implements ManualReviewService {
    ...
    public ManualReviewServiceImpl(
    ...
    @Override
    public Page<ManualReviewEntity> findByContentId(
        String contentId,
        Pageable pageable
    ) {
    ...
    @Override
    public Page<ManualReviewEntity> findByReviewerId(
        String reviewerId,
        Pageable pageable
    ) {
    ...
    @Override
    public Page<ManualReviewEntity> findByDecision(
        String decision,
        Pageable pageable
    ) {
    ...
    @Override
    public Optional<ManualReviewEntity> findLatestByContentId(
        String contentId
    ) {
        return manualReviewRepository.findFirstByContentIdOrderByReviewedAtDesc(
            contentId
        );
    }

    @Override
    public Optional<ManualReviewEntity> findLatestByContentIdAndReviewType(
        String contentId,
        String reviewType
    ) {
        return manualReviewRepository.findFirstByContentIdAndReviewTypeOrderByReviewedAtDesc(
            contentId,
            reviewType
        );
    }
    ...
    public Page<ManualReviewEntity> findByFilters(
        ...
        if (reviewDate != null) {
            ...
            criteriaList.add(
                Criteria.where("reviewedAt").gte(startOfDay).lte(endOfDay)
            );
        }
        ...
        // 执行查询
        List<ManualReviewEntity> records = mongoTemplate.find(
            query,
    ...
    @Override
    public Optional<ManualReviewEntity> findById(String id) {
        return manualReviewRepository.findById(id);
    }

    @Override
    public void deleteById(String id) {
        manualReviewRepository.deleteById(id);
    }
}
